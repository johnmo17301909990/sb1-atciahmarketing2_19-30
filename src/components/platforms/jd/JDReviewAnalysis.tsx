...
const keywordData = [
  ...
  { keyword: '京东自营', 频次: 176, 情感: 'positive' },
  { keyword: 'Plus会员', 频次: 156, 情感: 'positive' },
];
...
export function JDReviewAnalysis({ dateRange }: Props) {
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow p-4">
          <h4 className="font-semibold text-lg mb-2">总评价数</h4>
          <p className="text-3xl font-bold text-red-600">3,586</p>
        ...
        <div className="h-[400px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={reviewTrendData}>
              ...
              <Tooltip />
              <Legend />
              <Line yAxisId="left" type="monotone" dataKey="评价数" stroke="#FF4D4F" />
